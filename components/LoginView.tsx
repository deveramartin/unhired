      ...
      <div className="max-w-md w-full bg-zinc-900 border border-white/5 rounded-3xl p-6 sm:p-8 shadow-[0_15px_40px_rgba(0,0,0,0.6)] backdrop-blur-md relative overflow-hidden text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-400 font-sans leading-relaxed max-w-sm mx-auto">
            To generate personalized, high-performance resume insults and track your rejection timeline, log in below.
          </p>
        </div>
        ...
        <div className="bg-slate-950 border border-white/5 p-4 rounded-xl text-left font-mono text-[10px] space-y-1.5 text-slate-400">
          ...
          <div className="flex items-start gap-1.5 text-slate-300">
            <span className="text-emerald-500 font-bold">•</span>
            <span>Logs your past failures into a persistent historical list</span>
          </div>
        </div>
          ...
          >
            ...
            <svg className="h-5 w-5" viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
              <g transform="matrix(1, 0, 0, 1, 0, 0)">
                <path d="M21.35,11.1H12v2.7h5.38c-0.24,1.28 -0.96,2.37 -2.04,3.1v2.57h3.3c1.93,-1.78 3.04,-4.4 3.04,-7.49 0,-0.31 -0.03,-0.62 -0.08,-0.88Z" fill="#4285F4" />
                <path d="M12,20.6c2.43,0 4.47,-0.8 5.96,-2.18l-3.3,-2.57c-0.9,0.61 -2.07,0.98 -3.12,0.98 -2.43,0 -4.5,-1.64 -5.24,-3.84H2.89v2.66C4.38,18.59 7.91,20.6 12,20.6Z" fill="#34A853" />
                <path d="M6.76,13.01c-0.19,-0.57 -0.3,-1.18 -0.3,-1.8s0.11,-1.23 0.3,-1.8V6.75H2.89c-0.61,1.22 -0.96,2.6 -0.96,4.06s0.35,2.84 0.96,4.06l3.87,-2.86Z" fill="#FBBC05" />
                <path d="M12,6.44c1.32,0 2.5,0.45 3.44,1.35l2.58,-2.58C16.46,3.77 14.42,2.9 12,2.9c-4.09,0 -7.62,2.01 -9.11,4.95l3.87,2.86c0.74,-2.2 2.81,-3.84 5.24,-3.84Z" fill="#EA4335" />
              </g>
            </svg>
        ...
        <div className="pt-2 border-t border-white/5 flex items-center justify-center gap-1.5 text-[9px] text-slate-500 font-mono">
          ...
          <span>By continuing, you accept that AI opinions are highly fictional.</span>
        </div>
      </div>
    </div>
  );
